  ...
  return (
    <div className="menu">
      ...
      <div className="legend">
        ...
        <div className="legend-item">
          <span class="tag gluten-free">Gluten free*</span><br/>

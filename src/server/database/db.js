...
const updateReview = (foodtruckID, userReview) => {
  Foodtrucks.findOne({ foodtruckID }, { reviews: 1, overallRating: 1 }, async (err, data) => {
    ...
    await Foodtrucks.findOneAndUpdate({ foodtruckID }, { overallRating: rating, reviews })
  })
}
...
updateReview(1, {
  pennID: 119912,
  rating: 5,
  comment: 'nice foodtruck from cam',
})
